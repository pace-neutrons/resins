...
:py:class:`resins.Instrument` object and subsequent acquisition of the resolution
function.

Furthermore, each page contains a copy of all the data, i.e. all the parameters for all the models,
